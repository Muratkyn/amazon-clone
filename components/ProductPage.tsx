  ...
  return (
    <div >
      <div className='flex justify-center items-center w-[1500px]'>
        {product.map((product) => (
          <div className='h-[650px] w-[1200px] bg-white z-30 m-3  '>
          ...
          <div className='flex justify-center items-center mt-5'>
            <button onClick={() => dispatch(addToCart((product)))} className='bg-yellow-300 p-2 rounded-xl w-[70%] hover:bg-yellow-400 hover:border'>Aggiungi al carrello</button>
          </div>
        </div>
        ))}
      </div>
